package co.webnexs.tranznexs.gpsLocation;
...
public class AutoCompleteAdapter extends ArrayAdapter implements Filterable {
    ...
    public static ArrayList autocomplete(String input,Activity activity) {
        ...
        StringBuilder jsonResults = new StringBuilder();
            ...
            String locationUrl = "";
            try {
                locationUrl = "https://maps.googleapis.com/maps/api/place/autocomplete/json?key=AIzaSyArDrpO2VcEXtvkcc0r0GabkKUelC2mEMc" + URLEncoder.encode(input, "UTF-8");
